...
[AWS Copilot Basics - YouTube](https://www.youtube.com/watch?v=EqW--TKQ_PQ)
...
[Service Discovery - AWS Copilot CLI](https://aws.github.io/copilot-cli/docs/concepts/services/#service-discovery)
...
[AWS Copilot Exec Tutorial - YouTube](https://www.youtube.com/watch?v=Evrl9Vux31k)
