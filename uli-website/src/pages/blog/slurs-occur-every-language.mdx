...
The slur list is available on [Tattle’s GitHub](https://github.com/tattle-made/slur-list) under the Open Data License for use by interested researchers and activists, or Trust and Safety teams.
