...
On the front end, the result was the Uli plug-in which allows people to track and archive problematic content (useful also for analysing patterns and reporting to law enforcement), as well as redact slurs. It works primarily on X (formerly Twitter) and on several pages of the Chrome and Brave browsers. 
