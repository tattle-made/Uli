...
driver.install_addon(r'C:\Work\playground\uli-tester\extension\dist_ff\web-ext-artifacts\92ee12cafdb24c62975a-0.1.9.xpi')
sleep(5)
...
try:
    ...
    initial_count = len(os.listdir(r'C:\Users\bharg\Downloads')) # count the number of files in your downloads directory
