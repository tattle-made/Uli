defmodule UliCommunityWeb.UserAuth do
  use UliCommunityWeb, :verified_routes
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      UliCommunityWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule UliCommunityWeb.PageLive do
        use UliCommunityWeb, :live_view

        on_mount {UliCommunityWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{UliCommunityWeb.UserAuth, :ensure_authenticated}] do
