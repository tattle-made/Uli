...
const resources = {
    en: {
        translation: {
            ...
            message_archive_empty:
                "Looks like you haven't started archiving yet.",
            archive: 'Archive',
    ...
    hi: {
        translation: {
            ...
            navigation_debug: 'सेटिंग',
            navigation_slur_list: 'अभद्र शब्दों की सूची',
            ...
            message_error_preference_data_save:
                'प्राथमिकताऐं सहेजी नहीं जा सकी',
            message_archive_empty:
    ...
    ta: {
        translation: {
            ...
            navigation_slur_list: 'அவதூறு பட்டியல்',
